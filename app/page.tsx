              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                <div className="lg:col-span-7 animate-fade-up">
                  ...
                  <p className="text-base lg:text-lg text-text-secondary mb-8 max-w-lg leading-relaxed">
                    Set your income, plan your savings and investments first,
                    then spend what remains. A simple approach to building real
                    wealth.
                  </p>
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
              <div className="text-center mb-16 animate-fade-up">
                ...
                <p className="text-text-secondary text-base lg:text-lg max-w-lg mx-auto">
                  Set up your monthly plan in under a minute — then let
                  Finlytics handle the math.
                </p>
              </div>
